        ...
        <div className="d-md-flex justify-content-between align-items-center">
          ...
          <div className="col-md-5">
            <h1 className="aiPoweredStystemHeading">
              <span className="aiPoweredHeadingLatter">Payment </span>Processing
            </h1>
            <p className="aiPoweredPara">
            Calendex provides secure and reliable payment processing capabilities, accepting various payment methods and ensuring seamless transactions for customer.
            </p>
            ...
            <div className="d-grid aiItemsGrid">
              ...
              <div className="d-flex gap-4 ">
                ...
                <div className="aiItemNameAndPara">
                  <h1 className="aiItemNameText">Managing Tools & Teams</h1>
                  <p className="aiParaText">
                  Calendex empowers businesses to adapt and grow by easily adding tools and managing team members, devices, and locations.
                  </p>
                </div>
              </div>
              {/* start ai powered item-------------------- */}
              ...
              <div className="d-flex gap-4 ">
                ...
                />
                <div className="aiItemNameAndPara">
                  <h1 className="aiItemNameText">Remote Payments with Invoices</h1>
                  <p className="aiParaText">
                  Businesses can accept payments remotely by generating and sending invoices, simplifying payment collection processes.
                  </p>
                </div>
              </div>
              {/* start ai powered item-------------------- */}
              ...
              <div className="d-flex gap-4 ">
                ...
                <div className="aiItemNameAndPara">
                  <h1 className="aiItemNameText">Team Management</h1>
                  <p className="aiParaText">
                  Effortlessly schedule, manage, and pay your team members with Calendex's comprehensive Team Management feature.
                  </p>
                </div>
              </div>
              {/* end ai powered item-------------------- */}
