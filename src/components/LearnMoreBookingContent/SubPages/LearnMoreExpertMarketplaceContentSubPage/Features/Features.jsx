      ...
      <div className="container">
        ...
        <div className="d-md-flex align-items-center justify-content-between">
          ...
          <div className="col-md-4 mt-4 mt-md-0">
            <h1 className="calendexFeatureHeading">Save Employee Contracts</h1>
            <p className="calendexFeatureParagraph">
            Businesses can securely store and access employee contracts within Calendex for convenient reference.            </p>
        ...
        <div className="d-md-flex flex-row-reverse align-items-center justify-content-between mt-4 gap-3 gap-md-0 pt-4 pt-md-0">
          ...
          <div className="col-md-4 mt-3 mt-md-0">
            <div>
              ...
              Flexible Staff Display
              </h1>
              <p className="groupWorkingPara">
              Customize the calendar to display 2-10 staff members as desired, adapting to specific business requirements.
                            </p>
            </div>

            <div>
              <h1 className="groupWorkingHeading">Instant Staff Availability</h1>
              <p className="groupWorkingPara">
              Quickly check staff availability without the need to scroll through the calendar, ensuring efficient scheduling. 
                            </p>
            </div>
            ...
            <div>
              ...
              <p className="groupWorkingPara">
              Seamlessly handle all business locations within Calendex, simplifying administrative tasks.              </p>
            </div>
            {/* stat read more and contact us button---------------------- */}
            <div className="d-flex align-items-center justify-content-around justify-content-sm-start gap-4 mt-4 mt-md-0">
              <Link
