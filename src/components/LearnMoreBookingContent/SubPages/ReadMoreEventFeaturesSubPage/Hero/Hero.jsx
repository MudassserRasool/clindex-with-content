      ...
      <div className="container-fluid container-md pt-4">
        <div className="row justify-content-between">
          ...
          <div className="my-auto pb-4 col-md-6 z-index-1">
            ...
            <div className="mt-2">
              <h1 className="clindexHeroHeading">Customizable Note Categories</h1>
              {/* <h3 className="clindexHeroTitel">
                AI-Powered Booking System for All Businesses
              </h3> */}
            </div>
            <p className="heroParagraph">
            Create industry-specific note categories to organize and classify video and audio notes based on specific requirements.
            </p>
