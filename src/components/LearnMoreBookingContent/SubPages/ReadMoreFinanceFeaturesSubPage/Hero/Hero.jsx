      ...
      <div className="container-fluid container-md pt-4">
        <div className="row justify-content-between">
          ...
          <div className="my-auto pb-4 col-md-6 z-index-1">
            ...
            <div className="mt-2">
              <h1 className="clindexHeroHeading">Booking Widget</h1>
              {/* <h3 className="clindexHeroTitel">
                AI-Powered Booking System for All Businesses
              </h3> */}
            </div>
            <p className="heroParagraph">
            Seamlessly integrate Calendex for online appointment booking. Install the booking calendar on your website to display available slots and enable customers to book conveniently.
            </p>
