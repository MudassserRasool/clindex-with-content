      ...
      <div className="container-fluid container-md pt-4">
        <div className="row justify-content-between">
          ...
          <div className="my-auto pb-4 col-md-6 z-index-1">
            ...
            <div className="mt-2">
              <h1 className="clindexHeroHeading">Get Seen on Expert Marketplace for Free</h1>
              {/* <h3 className="clindexHeroTitel">
                AI-Powered Booking System for All Businesses
              </h3> */}
            </div>
            <p className="heroParagraph">
            Instantly expand your business reach with free advertising on Expert, a vast platform where customers can discover and book your services directly. Increase visibility, attract more customers, and maximize bookings.
            </p>
